...
| Vector-first export | Prefer SVG or high-resolution PNG for Markdown references | template export settings |
...
The templates export SVG, PDF, and PNG. Prefer SVG or high-resolution PNG for Markdown references; keep PDF only when needed as an image/archive format.
