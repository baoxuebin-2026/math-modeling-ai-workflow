...
Use this for important figures after the first Markdown draft is saved. The goal is to catch final-size readability problems before publication.

## Loop

1. Render at the intended final size. Do not rely on later scaling to fix readability.
